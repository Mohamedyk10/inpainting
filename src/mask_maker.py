...
HAUTEUR =  645 # Nombre de lignes
LARGEUR =  328 # Nombre de colonnes
NOM_FICHIER_MASQUE = "dog_example.mask.webp"

# --- DÉFINITION DE LA ZONE À MASQUER (EN PIXELS) ---
# Masque la zone centrale : de la ligne 80 à 200 et de la colonne 300 à 500.
Y1, Y2 = 203, 354 # Lignes (Hauteur)
X1, X2 = 47, 192 # Colonnes (Largeur)
